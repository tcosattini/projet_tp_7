...
class TestUrls(SimpleTestCase):
    ...
    def test_wip_url_is_resolved(self):
        url = reverse('WIP')
        self.assertEquals(resolve(url).func, wip)

    def test_add_url_is_resolved(self):
        url = reverse('utilisateur.add')
    ...
    def test_toggle_active_url_is_resolved(self):
        url = reverse('utilisateur.toggle', args=['1'])
        self.assertEquals(resolve(url).func, toggle_active)

    def test_change_url_is_resolved(self):
        url = reverse('utilisateur.change', args=['1'])
        self.assertEquals(resolve(url).func, change)
    ...
    def test_modificationObjet_url_is_resolved(self):
        url = reverse('modificationObjet', args=[
                      '1', '2', 'a', '3', '4', '5', '6', '7'])
    ...
    def test_modificationConditionnement_url_is_resolved(self):
        url = reverse('modificationConditionnement',
                      args=['1', '2', 'a', '3', '4'])
