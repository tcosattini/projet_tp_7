...
class TestUtilisateurs(TestCase):
  ...
  def test_utilisateurs_code(self):
    ...
    test_code1 = TUtilisateur.objects.create(
        code_utilisateur=100, username="test_code1")
  ...
  def test_utilisateurs_nom(self):
    ...
    test_nom1 = TUtilisateur.objects.create(
        nom_utilisateur="Dupont", prenom_utilisateur="Ariane", username="test_nom1")
    test_nom2 = TUtilisateur.objects.create(
        nom_utilisateur="Dupont", prenom_utilisateur="Ariane", username="test_nom2")
  ...
  def test_utilisateurs_role(self):
    ...
    test_role_utilisateur1 = TUtilisateur.objects.create(
        code_role=test_role1, username="test_role1")
  ...
  def test_utilisateurs_is_superuser(self):
    ...
    test_is_superuser1 = TUtilisateur.objects.create(
        username="test_is_superuser1")
