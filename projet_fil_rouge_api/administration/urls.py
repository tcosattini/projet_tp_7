...
urlpatterns = [
    ...
    re_path(r'^ongletObjets/(?P<idx>[0-9]+)$', views.ongletObjets, name='ongletObjet'),
    ...
    re_path(r'^ongletEmballages/(?P<idx>[0-9]+)$', views.ongletConditionnement, name='ongletConditionnement'),
