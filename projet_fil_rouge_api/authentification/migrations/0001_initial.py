    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('codcond', models.ForeignKey(blank=True, db_column='codcond', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='authentification.tconditionnement')),
                ('codobj', models.ForeignKey(blank=True, db_column='codobj', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='authentification.tobjet')),
            ],
            options={
                'db_table': 't_rel_cond',
                'managed': True,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('codcli', models.ForeignKey(blank=True, db_column='codcli', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='authentification.tclient')),
                ('id_dtl_commande', models.ForeignKey(blank=True, db_column='id_dtl_commande', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='authentification.tdtlcode')),
            ],
            options={
                'db_table': 't_entcde',
                'managed': True,
        ...
        migrations.AddField(
            model_name='tdtlcode',
            name='codobj',
            field=models.ForeignKey(blank=True, db_column='codobj', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='authentification.tobjet'),
        ),
        migrations.AddField(
            model_name='tclient',
            name='id_commune',
            field=models.ForeignKey(blank=True, db_column='id_commune', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='authentification.tcommunes'),
        ),
        migrations.CreateModel(
            name='TUtilisateur',
            fields=[
                ...
                ('code_role', models.ForeignKey(blank=True, db_column='code_role', null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='authentification.trole')),
            ],
            options={
